<!-- ARCHIVED — Milestone v1.1 Swim-Lane Module Report · SHIPPED 2026-07-02 · 12/12 requirements
     satisfied (see v1.1-MILESTONE-AUDIT.md). Frozen snapshot; the live REQUIREMENTS.md was git-rm'd
     at close and is fresh for the next milestone. History preserved in git. -->
