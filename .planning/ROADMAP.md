...
**Plans**: 4 plans
  ...
  - [ ] 02-01-PLAN.md — Additive `SectionBinding.kpi_endpoints` endpoint-pairing (references, not re-mints); Phase-1 gates stay green (COMP-01, COMP-02)
  - [ ] 02-02-PLAN.md — `compose.py` core: pure `compute_delta` + `compose_module_report` (per-lane strip+claims, deterministic Draft Surface, missing union) (COMP-01, COMP-02, COMP-03)
...
| 2. Module-scope Report composer | 0/4 | Planned | - |
