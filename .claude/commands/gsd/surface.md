...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/newsletters/.claude/.gsd-surface.json`
(sibling to `/home/user/newsletters/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/newsletters/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/newsletters/.claude/skills`).
...
`/home/user/newsletters/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/newsletters/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/newsletters/.claude/.gsd-surface.json`
Install profile marker: `/home/user/newsletters/.claude/.gsd-profile`
Skill dirs: `/home/user/newsletters/.claude/skills/gsd-*/`
Engine module: `/home/user/newsletters/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/user/newsletters/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
