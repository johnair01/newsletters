...
<execution_context>
@/home/user/newsletters/.claude/gsd-core/workflows/manager.md
...
Read and execute `/home/user/newsletters/.claude/gsd-core/workflows/analyze-dependencies.md` end-to-end.
