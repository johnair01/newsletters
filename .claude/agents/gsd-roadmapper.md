...
Reference full template: `/home/user/newsletters/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/newsletters/.claude/gsd-core/templates/state.md`.
