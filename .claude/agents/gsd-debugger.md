...
<required_reading>
@/home/user/newsletters/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@/home/user/newsletters/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/newsletters/.claude
                  → checks /home/user/newsletters/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/newsletters/.claude/gsd-core
                  → writes to /home/user/newsletters/.claude/gsd-core/hooks/
...
@/home/user/newsletters/.claude/gsd-core/references/thinking-models-debug.md
...
- Read @/home/user/newsletters/.claude/gsd-core/references/common-bug-patterns.md
