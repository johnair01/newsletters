...
```markdown
Read /home/user/newsletters/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/newsletters/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/newsletters/.claude/agents/gsd-ui-checker.md for instructions.
