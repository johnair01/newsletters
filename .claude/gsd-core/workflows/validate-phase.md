...
```
Agent(
  prompt="Read /home/user/newsletters/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/newsletters/.claude/gsd-core/templates/VALIDATION.md`
